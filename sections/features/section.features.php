			...
			return array(
				'feature_settings' => array(
							...
							'feature_source' => array(
									...
									'exp' => "By default the feature section will use feature posts, you can also set the source for features to a blog post category. Set the category ID in its option below. <br/> <strong>NOTE: If you select to use blog posts, a new option panel for setup will be added on post creation and editing pages.</strong>"
								),
