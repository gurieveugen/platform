...
<div class="metabar">
								...
								<?php if(pagelines_show_excerpt( get_the_ID() )): // Post Excerpt ?>
										...
										<?php if(is_home() && !pagelines_show_content( get_the_ID() )): // 'Continue Reading' link ?>
											<a class="continue_reading_link" href="<?php the_permalink(); ?>" title="<?php _e("View", 'pagelines');?> <?php the_title_attribute(); ?>">
												<?php e_pagelines('continue_reading_text', __('Continue Reading', 'pagelines'));?> <span>&rarr;</span>
											</a>
