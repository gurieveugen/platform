...
<table class="cart">
	...
	<?php while(shopp('cart','promos')): ?>
		<tr><td colspan="4" class="money"><?php _e('Voucher discount','Shopp'); ?><strong><?php shopp('cart','promo-discount',array('before' => '&nbsp;&mdash;&nbsp;')); ?></strong></td></tr>
	<?php endwhile; ?>
	...
	<tr class="totals">
		<th colspan="3" scope="row"><?php _e('Discount','Shopp'); ?></th>
		<td class="money">-<?php shopp('cart','discount'); ?></td>
	</tr>
	<?php endif; ?>
	<?php if (shopp('cart','needs-shipped')): ?>
	<tr class="totals">
		<th colspan="3" scope="row"><?php shopp('cart','shipping','label='.__('Shipping','Shopp')); ?></th>
		<td class="money"><?php shopp('cart','shipping'); ?></td>
	</tr>
	<?php endif; ?>
	<tr class="totals">
		<th colspan="3" scope="row"><?php shopp('cart','tax','label='.__('Tax','Shopp')); ?></th>
		<td class="money"><?php shopp('cart','tax'); ?></td>
	</tr>
	<tr class="totals total">
		<th colspan="3" scope="row"><?php _e('Total','Shopp'); ?></th>
		<td class="money"><?php shopp('cart','total'); ?></td>
	</tr>
	<tr class="buttons">
		<td colspan="2" style="text-align:left;"><?php shopp('cart','promo-code'); ?></td>
		<td colspan="2"><?php shopp('cart','update-button'); ?></td>
	</tr>
</table>
