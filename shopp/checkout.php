...
<?php if (shopp('cart','hasitems')): ?>
	<?php while(shopp('cart','items')): ?>
		<?php if (strpos(shopp('cartitem','options','show=selected&before=(&after=)&return=true'), 'voucher')) { $voucheradded = true; } ?>
	<?php endwhile; ?>
	...
	<ul>
		...
		<?php endif; ?>
			...
			<div>
				<?php shopp('checkout','billing-address','title='.__('Billing street address','Shopp')); ?>
		...
		<?php if (shopp('cart','needs-shipped')): ?>
			<div class="inline" style="display:none;"><?php shopp('checkout','same-shipping-address'); ?></div>
			</li>
		...
		<?php if ($voucheradded) : ?>
		<li class="voucher">
			<label class="section-title" for="voucher"><?php _e('Voucher Details','Shopp'); ?></label>
			<div class="left">
				<div>
					<label for="voucher-to"><?php _e('To','Shopp'); ?> <font style="color:#FF0000;">*</font></label>
					<input type="text" name="voucher[to]" id="voucher-to" class="required" />
				</div>
				<div>
					<label for="voucher-from"><?php _e('From','Shopp'); ?></label>
					<input type="text" name="voucher[from]" id="voucher-from" />
				</div>
				<div>
					<label for="voucher-phone"><?php _e('Phone','Shopp'); ?> <font style="color:#FF0000;">*</font></label>
					<input type="text" name="voucher[phone]" id="voucher-phone" class="required" />
				</div>
				<div>
					<label for="voucher-email"><?php _e('Email','Shopp'); ?></label>
					<input type="text" name="voucher[email]" id="voucher-email" />
				</div>
			</div>
		</li>
		<?php endif; ?>
